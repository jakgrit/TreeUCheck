      ...
      <div class="item active">
        <img src="{{asset('img/01.png')}}" alt="..." style="width:100%; height:100%">
				<div class="carousel-caption" >
					<h3 style="font-size : 80px; color : white" class="fonts1">
						ระบบลงทะเบียนการประชุม
					</h3>
					<p class="fonts1" style="font-size : 20px; color : white">
						ระบบลงทะเบียนออนไลน์ สำหรับการเข้าร่วมประชุม อบรมสัมมนา <br>
						ตรวจสอบการลงทะเบียน 
					</p>
				</div>
			</div>
      <div class="item fonts1">
        <img src="{{asset('img/04.png')}}" alt="..." style="width:100%; height:100%">
				<div class="carousel-caption" >
					<h3 style="font-size : 80px; color : white" class="fonts1">
						ระบบเช็คชื่อ
					</h3>
					<p class="fonts1" style="font-size : 20px; color : white">
						ระบบเช็คชื่อออนไลน์ สำหรับผู้เข้าร่วมการประชุม อบรมสัมมนา
					</p>
				</div>
      </div>
    </div>
...
<form action="{{ route('login') }}" method="post">
  {{ csrf_field() }}
  <div class="modal fade fonts1" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="z-index:20000; margin-left:17px;">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" style="background-color:#58B957; border-color:#58B957;">เข้าสู่ระบบ</button>
        </div>
      </div>
    </div>
  </div>
	...
	<div class="fonts1" style="background-color:#313332; width:100%; height:300px; margin-top:100px; padding-top:30px; ">
