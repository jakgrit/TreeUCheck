    ...
    <div class="fonts1" style="width: 75%;">
      <div class="row fonts1" style="text-align: center; padding-top: 50px";>
        <div class="col-md-6">
          ...
          <p class="text">เพื่อเพิ่มประกาศลงทะเบียนกิจกรรมต่างๆ สัมนา ประชุม และอื่นๆ</p>
       ...
       <div class="col-md-6">  
          ...
          <h4 class="service-heading fonts1" style="font-size:25px; padding-top: 10px">ระบบสมัครสมาชิก</h4>
          <!-- <p class="text-muted"> <span style="color:#1f7cab;">สำหรับเจ้าหน้าที่</span>กรุณาเข้าสู่ระบบ </p> -->
          <p>เพื่อทำการเพิ่มผู้ใช้งานระบบเลงทะเบียน และเช็คชื่อ</p>
...
<div class="form-inline fonts1" style="padding-top: 30px; font-size:15px">
  ...
  <div class="col-md-4">
    <div class="fonts1 left" style="font-size:25px; margin-bottom:10px; ">{{ $data[$i]['name'] }}</div>
    <div class="fonts1" style="font-size:16px; color: #807F7D; margin-bottom:10px;">{{ $data[$i]['detail'] }}</div>
    ...
    <div  style="margin-bottom:8px; padding-left: 50px"><span class="glyphicon glyphicon-paperclip"></span> งานเริ่มเวลา {{ $data[$i]['time'] }} ถึงเวลา {{ $data[$i]['timeend'] }}</div>
